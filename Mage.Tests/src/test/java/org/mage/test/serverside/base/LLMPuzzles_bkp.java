...
public class LLMPuzzles extends CardTestPlayerBaseAI {
    ...
    public void test_PC_072115_puzzle_llm_metrics() {
        ...
        // Opponent board
        addCard(Zone.BATTLEFIELD, playerB, "Mountain");
        addCard(Zone.HAND, playerB, "Chain Lightning");
    ...
    public void test_PS_M207_puzzle_llm_metrics() {
        ...
        // Puzzle file: forge/forge-gui/res/puzzle/PS_M207.pzl
        /*
         * [metadata]
        ...
        // Setup PS_M207 puzzle scenario
        // PlayerA (human): 20 life
        setLife(playerA, 20);
        addCard(Zone.HAND, playerA, "Strength of the Pack");
        addCard(Zone.HAND, playerA, "Depose // Deploy");
        addCard(Zone.HAND, playerA, "Storm the Citadel");
        ...
        addCard(Zone.HAND, playerA, "Short Sword");
        addCard(Zone.BATTLEFIELD, playerA, "Gideon Blackblade");
        addCounters(1, PhaseStep.MAIN1, playerA, "Gideon Blackblade", CounterType.LOYALTY, 6);
        addCard(Zone.BATTLEFIELD, playerA, "Blackblade Reforged");
        addCard(Zone.BATTLEFIELD, playerA, "Omnispell Adept");
        addCard(Zone.BATTLEFIELD, playerA, "Shanna, Sisay's Legacy"); // ID:9
        addCard(Zone.BATTLEFIELD, playerA, "Sigiled Sword of Valeron"); // TODO: Attach to Shanna, Sisay's Legacy (ID:9)
        addCard(Zone.BATTLEFIELD, playerA, "Dauntless Bodyguard"); // ID:10 // TODO: ChosenCards: Shanna, Sisay's Legacy
                                                                   // (ID:9)
        addCard(Zone.BATTLEFIELD, playerA, "Forebear's Blade"); // TODO: Attach to Dauntless Bodyguard (ID:10)
        addCard(Zone.BATTLEFIELD, playerA, "Hallowed Fountain"); // NoETBTrigs
        addCard(Zone.BATTLEFIELD, playerA, "Hallowed Fountain"); // NoETBTrigs
        addCard(Zone.BATTLEFIELD, playerA, "Hallowed Fountain"); // NoETBTrigs
        addCard(Zone.BATTLEFIELD, playerA, "Temple Garden"); // NoETBTrigs
        addCard(Zone.BATTLEFIELD, playerA, "Temple Garden"); // NoETBTrigs
        addCard(Zone.BATTLEFIELD, playerA, "Temple Garden"); // NoETBTrigs
