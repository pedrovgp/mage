...
import mage.player.ai.ComputerPlayer7Instrumented;
import mage.target.Target;
import mage.target.TargetCard;

/**
 * AI: helper class for tests - ComputerPlayer7Instrumented version
 * <p>
 * Copied-pasted methods from TestComputerPlayer7, see docs in there
 *
 * @author Generated for trajectory logging tests
 */

public final class TestComputerPlayer7Instrumented extends ComputerPlayer7Instrumented {

    private TestPlayer testPlayerLink;

    public TestComputerPlayer7Instrumented(String name, RangeOfInfluence range, int skill) {
