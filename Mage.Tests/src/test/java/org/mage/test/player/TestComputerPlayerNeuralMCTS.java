...
import mage.player.ai.ComputerPlayerNeuralMCTS;
...
public final class TestComputerPlayerNeuralMCTS extends ComputerPlayerNeuralMCTS {

    private TestPlayer testPlayerLink;

    public TestComputerPlayerNeuralMCTS(String name, RangeOfInfluence range, int skill) {
